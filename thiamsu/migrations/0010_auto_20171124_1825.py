...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='lang',
            field=models.CharField(choices=[('tailo', 'translation_lang_tailo'), ('hanzi', 'translation_lang_hanzi')], max_length=5),
        ),
        migrations.AlterField(
            model_name='headline',
            name='end_time',
        ...
        migrations.AlterField(
            model_name='headline',
            name='song',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='thiamsu.Song', verbose_name='song'),
        ),
        migrations.AlterField(
            model_name='headline',
            name='start_time',
        ...
        migrations.AlterField(
            model_name='newword',
            name='created_at',
            field=models.DateTimeField(auto_now_add=True, verbose_name='new_word_created_at'),
        ),
        migrations.AlterField(
            model_name='newword',
            name='reference_url',
            field=models.CharField(max_length=100, verbose_name='new_word_reference_url'),
        ),
        migrations.AlterField(
            model_name='newword',
            name='song',
        ...
        migrations.AlterField(
            model_name='translation',
            name='contributor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='translation_contributor'),
        ),
        migrations.AlterField(
            model_name='translation',
            name='created_at',
            field=models.DateTimeField(auto_now_add=True, verbose_name='translation_created_at'),
        ),
        migrations.AlterField(
            model_name='translation',
            name='lang',
            field=models.CharField(choices=[('tailo', 'translation_lang_tailo'), ('hanzi', 'translation_lang_hanzi')], max_length=5, verbose_name='translation_lang'),
        ),
        migrations.AlterField(
            model_name='translation',
            name='line_no',
